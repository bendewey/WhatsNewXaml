...
{
    public class HorizontalTileCanvas : Canvas
    {
        public static readonly DependencyProperty ImageSourceProperty = DependencyProperty.Register("ImageSource", typeof(ImageSource), typeof(HorizontalTileCanvas), new PropertyMetadata(null, ImageSourceChanged));

        private Size lastActualSize;

        public HorizontalTileCanvas()
        {
        ...
        {
            HorizontalTileCanvas self = (HorizontalTileCanvas)o;
