...
namespace NewXaml
{
    ...
    sealed partial class App : Application
    {
        ...
        private Type ResolveView(string view)
        {
            if (_assemblyTypes == null)
            {
                var currentAssembly = GetType().GetTypeInfo().Assembly;
                _assemblyTypes = currentAssembly.ExportedTypes.ToArray();
            }
            return _assemblyTypes.FirstOrDefault(t => string.Equals(t.Name, view, StringComparison.OrdinalIgnoreCase) 
                || string.Equals(t.Name, view + "Page", StringComparison.OrdinalIgnoreCase));
        }
